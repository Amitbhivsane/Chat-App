...
// import SidebarSkeleton from "./skeletones/SidebarSkeleton";
  ...
  return (
    ...
    >
      ...
      <div className="border-b border-base-300 w-full p-3 lg:p-5">
        ...
        {/* Online Filter Toggle - Now visible on all screen sizes */}
        <div className="mt-2 flex items-center gap-2 px-1 lg:px-0">
          <label className="cursor-pointer flex items-center gap-2">
            <input
              type="checkbox"
              checked={showOnlineOnly}
